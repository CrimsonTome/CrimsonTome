...
- [pop-os/popsicle](https://github.com/pop-os/popsicle) - Multiple USB File Flasher (3 days ago)
- [catppuccin/kde](https://github.com/catppuccin/kde) - 🌻 Soothing pastel theme for KDE (3 days ago)
- [catppuccin/bat](https://github.com/catppuccin/bat) - 🦇️ Soothing pastel theme for Bat (3 days ago)
- [virt-manager/virt-manager](https://github.com/virt-manager/virt-manager) - Desktop tool for managing virtual machines via libvirt (3 days ago)
