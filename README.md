...
- [pyrodactyl-oss/pyrodactyl](https://github.com/pyrodactyl-oss/pyrodactyl) -  Pyrodactyl is the Pterodactyl-based game server panel that&#39;s faster, smaller, safer, and more accessible than Pelican.  (2 days ago)
- [ChrisDKN/Amethyst-Mod-Manager](https://github.com/ChrisDKN/Amethyst-Mod-Manager) - A Linux native mod manager for a variety of games (6 days ago)
- [Faugus/faugus-launcher](https://github.com/Faugus/faugus-launcher) - A simple and lightweight app for running Windows games using UMU-Launcher (6 days ago)
